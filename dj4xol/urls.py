...
urlpatterns = [
    ...
    url(r'^profile/games/(?P<game_short_id>[0-9a-z]{8})/delete/$', views.delete_owned_game, name='delete_owned_game'),
    url(r'^profile/server-settings/$', views.server_settings, name='server_settings'),
    url(r'^profile/help-pages/$', views.help_pages_cms, name='help_pages_cms'),
    ...
    url(r'^races/(?P<race_short_id>[0-9a-z]{8})/edit/$', views.edit_race, name='edit_race'),
    url(r'^races/(?P<race_short_id>[0-9a-z]{8})/delete/$', views.delete_race, name='delete_race'),
    ...
    url(r'^help/exploration/$', views.help_exploration, name='help_exploration'),
    url(r'^help/colonising/$', views.help_colonising, name='help_colonising'),
    url(r'^help/colony-management/$', views.help_colony_management, name='help_colony_management'),
    url(r'^help/mining-salvage/$', views.help_mining_salvage, name='help_mining_salvage'),
    ...
    url(r'^help/special-race-effects/$', views.help_special_race_effects, name='help_special_race_effects'),
    ...
    url(r'^help/pages/(?P<slug>[-a-z0-9]+)/$', views.custom_help_page, name='custom_help_page'),
    ...
    url(r'^(?P<game_short_id>[0-9a-z]{8})/debug/create-anomaly/$', views.debug_create_anomaly, name='debug_create_anomaly'),
    url(r'^(?P<game_short_id>[0-9a-z]{8})/debug/create-anomaly/(?P<fleet_short_id>[0-9a-z]{12})/$', views.debug_create_anomaly, name='debug_create_anomaly_for_fleet'),
    ...
    url(r'^(?P<game_short_id>[0-9a-z]{8})/fleets/$', views.fleet_list, name='fleet_list'),
    url(r'^(?P<game_short_id>[0-9a-z]{8})/fleets/action/(?P<action>[-a-z]+)/$', views.fleet_list_bulk_action, name='fleet_list_bulk_action'),
    url(r'^(?P<game_short_id>[0-9a-z]{8})/fleets/(?P<fleet_short_id>[0-9a-z]{12})/(?P<action>[-a-z]+)/$', views.fleet_list_action, name='fleet_list_action'),
    url(r'^(?P<game_short_id>[0-9a-z]{8})/colonies/$', views.colony_list, name='colony_list'),
    url(r'^(?P<game_short_id>[0-9a-z]{8})/colonies/action/(?P<action>[-a-z]+)/$', views.colony_list_bulk_action, name='colony_list_bulk_action'),
    url(r'^(?P<game_short_id>[0-9a-z]{8})/colonies/(?P<star_short_id>[0-9a-z]{12})/(?P<action>[-a-z]+)/$', views.colony_list_action, name='colony_list_action'),
