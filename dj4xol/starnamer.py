...
class StarNamer():
    _data = ['Eridanus', 'Eridani', 'Acamar', 'Cassiopeia', 'Achird',
             ...
             'Exodus', "Ursa", 'Alfirk', 'Algedi', 'Aldulfin', 'Alfarasalkamil',
             ...
             'Cexing', 'Chechia', 'Chaophraya', 'Chalawan', 'Chara', 'Detroit',
             'Deltoton', 'Plymouth', 'Danfeng', 'Ocean', 'Dombay', 'Dofida',
             'Diya', 'Dazzle', 'Blazes', 'Sparkle', 'Blue', 'Red', 'Ebla',
             'Dziban', 'Electra', 'Alnath', 'Hubble', 'Tycho', 'Elnath',
             'Edwin', 'Eltanin', 'Elkurud', 'Elgafar', 'Discovery', 'Oumuamua',
             'Sagittarius', 'Alnitak', 'Alnilam', 'Llama', 'Alshat', 'Aludra',
             'Alula', 'Alya', 'Crater', 'Ascella', 'Atakoraka', 'Apostrophe',
             ...
             'Sirius', 'Lalande', 'Cloud-n', 'Wise', 'Tau', 'Luyten', 'Ross',
             ...
             'Fizz', 'Adriana', 'Beata', 'Charmaine', 'Clarina',
