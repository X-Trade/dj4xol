...
HULL_TECH_ROWS = [
    ...
    },
    {
        ...
        "level": 5,
        "name": "Frigate Hull",
        "description": "Standard escort hull with stronger armor and internal bulkheads.",
        "tech_type": "HULL",
        "params_json": '{"max_cargo_capacity": 200, "max_fuel": 100, "hull_thumbnail_class": "fighter", "defense_level": 0.1}',
        "display_order": 220,
        "enabled": True,
    },
    {
        ...
        "level": 6,
        "name": "Freighter Hull",
        "description": "Bulk cargo frame with expanded holds and reinforced fuel tanks.",
        "tech_type": "HULL",
    ...
    },
    {
        ...
        "level": 8,
        "name": "Tanker Hull",
        "description": "Long range transport.",
        "tech_type": "HULL",
        "params_json": '{"max_cargo_capacity": 400, "max_fuel": 800, "hull_thumbnail_class": "tanker", "defense_level": -0.1}',
        "display_order": 230,
        "enabled": True,
    },
    {
        ...
        "level": 10,
        "name": "Capital Hull",
        "description": "Standardised ship-of-the-line with compartments for everything. Extra armour included as standard.",
        "tech_type": "HULL",
        "params_json": '{"max_cargo_capacity": 1000, "max_fuel": 1000, "hull_thumbnail_class": "capital", "defense_level": 0.9}',
        "display_order": 235,
        "enabled": True,
    },
    {
        ...
        "level": 12,
        "name": "City Hull",
        "description": "Mobile megastructure for empires at scale.",
        "tech_type": "HULL",
        "params_json": '{"max_cargo_capacity": 10000, "max_fuel": 10000, "hull_thumbnail_class": "city", "defense_level": 1.2}',
        "display_order": 240,
        "enabled": True,
    },
]
